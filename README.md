...
| [**envelope-pattern**](packages/envelope-pattern) | Pattern matching for Gordian Envelope - query and extract data from Envelope structures. Supports leaf, structure, and meta patterns with subject/predicate/object matching and tree traversal. [📖 API Docs](https://bcts.dev/docs/envelope-pattern) | [bc-envelope-pattern-rust](https://github.com/BlockchainCommons/bc-envelope-pattern-rust) |
